...
def search():
    ...
    if not feature_text :
        return render_template('search.html', name=project_name,netid=net_id, check=check, check2=check2, mate2=mate2,  mate=mate, flag=flag, flag2 = flag2,
                                ...
                                name_feat=[],name_val=[],spvals=[],prefs=str(preference))
    ...
    if budget and feature_text and condition:
        ...
        def main(budget, feature_text,condition):
            phones = {}
            old_specs = {}
            labels = []
            ...
            return [result,urls,rev_query,scores,ml_prices,spec_names,feat_plot,feat_val,spec_vals]

        final = main(budget,feature_text,condition)
